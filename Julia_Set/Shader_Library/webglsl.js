...
preload('https://omerkel.github.io/Fractals/Julia_Set/Shader_Library/');
// preload('http://127.0.0.1:8000/');

function preload(base_url) {
  vertex_url = base_url + 'julia.vert';
  fragment_url = base_url + 'julia.frag';
  fetch(vertex_url)
